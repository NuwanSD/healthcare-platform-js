        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="./pages/doctor.php">Doctor</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" href="./pages/record.php">Record</a>
              </li>
              <li class="nav-item">
          ...
          <div class="col mb-lg-3">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="./pages/appointment.php" class="btn btn-primary"
                  >Go Appointments</a
                >
              </div>
            </div>
          ...
          <div class="col">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="./pages/record.php" class="btn btn-primary"
                  >Go Records</a
                >
              </div>
            </div>
          ...
          <div class="col">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="./pages/doctor.php" class="btn btn-primary"
                  >Go Doctors</a
                >
              </div>
            </div>
